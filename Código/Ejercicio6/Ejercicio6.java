...
public class Ejercicio_6 {
    ...
    StringBuilder Expresion = new StringBuilder(); //Se utiliza para construir y manipular cadenas de caracteres de manera eficiente.
        ...
        while (NumeroBits < 1 || NumeroBits > 5) { //Si el numero ingresado es menor a 0 o mayor a 6 bits deberea ingresar nevamente la cantidad.
                System.out.println("El número ingresado no es 0 ni 1. Ingrese nuevamente:");
                NumeroBits = obj.nextInt();
        }
        ...
        for (int i = 0; i < Filas; i++) { // Solicitar al usuario ingresar los valores de resultado para cada combinación de bits.
            ...
            while (resultados[i] != 0 && resultados[i] != 1) { //Si el numero ingresado no es 0 o 1 se debera volver a ingresar el valor.
                System.out.println("El número ingresado no es 0 ni 1. Ingrese nuevamente:");
                resultados[i] = obj.nextInt();
            }
        }
